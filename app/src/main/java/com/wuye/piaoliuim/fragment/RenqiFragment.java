...
import com.wuye.piaoliuim.adapter.FuhaoBangrqAdapter;
...
public class RenqiFragment extends BaseFragement implements DialogView.DialogViewListener {
    ...
    FindData findData;
    View headerView;
    FuhaoBangrqAdapter fuhaoBangAdapter;
    String id1, id2, id3;
    ...
    private void setAdapter(FindData findData) {
        ...
        tvJb1.setText(findData.res.getPublicLists().get(0).getFans());
        tvJb2.setText(findData.res.getPublicLists().get(1).getFans());
        tvJb3.setText(findData.res.getPublicLists().get(2).getFans());
        ...
        fuhaoBangAdapter = new FuhaoBangrqAdapter(getBaseActivity(), R.layout.adapter_bangdarql_item, findData.res.getPublicLists());
