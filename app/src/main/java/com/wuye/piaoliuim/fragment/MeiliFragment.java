...
/**
 * @ClassName MeiliFragment
 * @Description
 * @Author VillageChief
 * @Date 2019/12/23 16:55
 */
public class MeiliFragment extends BaseFragement implements DialogView.DialogViewListener {
    ...
    private void setAdapter(FindData findData) {
        headerView = getLayoutInflater().inflate(R.layout.fragment_meili, null);
        ...
        Glide.with(getBaseActivity())
                .load(ImagUrlUtils.getImag(findData.res.getPublicLists().get(0).getLitpic())).apply(options)
                .into(imageView1);
        Glide.with(getBaseActivity())
                .load(ImagUrlUtils.getImag(findData.res.getPublicLists().get(1).getLitpic())).apply(options)
                .into(imageView2);
        Glide.with(getBaseActivity())
                .load(ImagUrlUtils.getImag(findData.res.getPublicLists().get(2).getLitpic())).apply(options)
                .into(imageView3);
