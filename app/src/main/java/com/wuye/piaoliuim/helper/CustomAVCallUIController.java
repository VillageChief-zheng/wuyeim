...
import com.wuye.piaoliuim.activity.imactivity.TRTCActivity;
...
import static com.wuye.piaoliuim.helper.CustomMessage.VIDEO_CALL_ACTION_ACCEPTED;
import static com.wuye.piaoliuim.helper.CustomMessage.VIDEO_CALL_ACTION_DIALING;
import static com.wuye.piaoliuim.helper.CustomMessage.VIDEO_CALL_ACTION_HANGUP;
import static com.wuye.piaoliuim.helper.CustomMessage.VIDEO_CALL_ACTION_LINE_BUSY;
import static com.wuye.piaoliuim.helper.CustomMessage.VIDEO_CALL_ACTION_REJECT;
import static com.wuye.piaoliuim.helper.CustomMessage.VIDEO_CALL_ACTION_SPONSOR_CANCEL;
import static com.wuye.piaoliuim.helper.CustomMessage.VIDEO_CALL_ACTION_SPONSOR_TIMEOUT;

/**
 * @ClassName CustomAVCallUIController
 * @Description
 * @Author VillageChief
 * @Date 2020/1/2 10:37
 */
public class CustomAVCallUIController extends TRTCCloudListener {
    ...
    private CustomAVCallUIController() {
        mTRTCCloud = TRTCCloud.sharedInstance(WuyeApplicatione.instance());
    ...
    public void onDraw(ICustomMessageViewGroup parent, CustomMessage data) {
        ...
        View view = LayoutInflater.from(WuyeApplicatione.instance()).inflate(R.layout.test_custom_message_av_layout1, null, false);
