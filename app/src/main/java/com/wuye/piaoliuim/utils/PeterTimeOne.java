...
public class PeterTimeOne extends CountDownTimer {

    private Button button,buttons;
    private long millisUntilFinished;

    public PeterTimeOne(long millisInFuture, long countDownInterval, final Button button,final Button buttons) {
    ...
    public void onTick(long millisUntilFinished) {//计时过程显示
        ...
        Log.i("pppppp",(int) Math.floor(millisUntilFinished / 60000)+"");
