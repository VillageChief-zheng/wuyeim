...
public class PeterTimeThree  extends CountDownTimer {

    private Button button,buttons;
    private long millisUntilFinished;

    public PeterTimeThree(long millisInFuture, long countDownInterval, final Button button,final Button buttons) {
