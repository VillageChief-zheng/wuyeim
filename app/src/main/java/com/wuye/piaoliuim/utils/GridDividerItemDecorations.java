...
/**
 * @ClassName GridDividerItemDecorations
 * @Description
 * @Author VillageChief
 * @Date 2019/12/20 13:37
 */
public class GridDividerItemDecorations extends RecyclerView.ItemDecoration {
     ...
     */
    public GridDividerItemDecorations(Context context, int firstAndLastColumnW, int firstRowTopMargin, int lastRowBottomMargin) {
        mContext = context;
