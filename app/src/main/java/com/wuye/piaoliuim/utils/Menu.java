...
//                }
        ...
        if (menuType == MENU_TYPE_CONVERSATION) {
            action.setActionName(mActivity.getResources().getString(R.string.quxiaozhiding));
            action.setActionClickListener(popActionClickListener);
            action.setIconResId( R.mipmap.ic_qq);
        ...
        if (menuType == MENU_TYPE_CONTACT) {
            ...
            action = new PopMenuAction();
            action.setActionName(mActivity.getResources().getString(R.string.quxiaozhiding));
            action.setIconResId(R.mipmap.wxpay_logo);
            action.setActionClickListener(popActionClickListener);
            menuActions.add(action);
        }
    ...
    public void show() {
        ...
        mMenuWindow.setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.ic_camera));
