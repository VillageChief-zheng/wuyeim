...
/**
 * @ClassName FuhaoBangmlAdapter
 * @Description
 * @Author VillageChief
 * @Date 2020/1/15 17:25
 */
public class FuhaoBangmlAdapter extends BaseQuickAdapter<FindData.Res.FIndList, BaseViewHolder> {
    ...
    public FuhaoBangmlAdapter(Context context, @LayoutRes int layoutResId, @Nullable List<FindData.Res.FIndList> data) {
    ...
    protected void convert(BaseViewHolder helper, FindData.Res.FIndList rseckillRow) {
        ...
        helper.setText(R.id.tv_number, helper.getAdapterPosition()+3 + "")
                .setText(R.id.tv_jinbi, " 魅力值：" + rseckillRow.getTotal_rece_gold())
        ;
